...
public class Prints {
	...
	public static Prints prints(Boolean... bool) {return print(bool);}

	public static Prints prints(boolean... b) {return print(objectArray(b));}

	public static Prints prints(Character... character) {return print(character);}

	public static Prints prints(char... c) {return print(objectArray(c));}

	public static Prints prints(Short... short1) {return print(short1);}

	public static Prints prints(short... srt) {return print(objectArray(srt));}

	public static Prints prints(Byte... byte1) {return print(byte1);}

	public static Prints prints(byte... bte) {return print(objectArray(bte));}

	public static Prints prints(Integer... integer) {return print(integer);}

	public static Prints prints(int... i) {return print(objectArray(i));}

	public static Prints prints(Long... long1) {return print(long1);}

	public static Prints prints(long... l) {return print(objectArray(l));}

	public static Prints prints(Float... float1) {return print(float1);}

	public static Prints prints(float... f) {return print(objectArray(f));}

	public static Prints prints(Double... double1) {return print(double1);}
	...
	public static Character printr(Character character) {
		print(character);
		return character;
	}
