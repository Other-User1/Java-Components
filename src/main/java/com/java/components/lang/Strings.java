...
import com.java.components.lang.annotation.Unused;
	...
	public String skip(String delimiter) {
		...
		for (int i = 0; i < delimiter.length(); i++) {
			switch (delimiter.charAt(i)) {
				case '?', '+', '-', '*', '(', ')', '[', ']', '{', '}', '|', '$': { builder.append("\\").append(delimiter.charAt(i)).append("|"); break; }
				case '\\': { builder.append("\\\\|"); break; }
				default: { builder.append(delimiter.charAt(i)).append("|"); break; }
			}
		}
